"""Provide functionality to interact with the vlc http interface."""
import logging

from .vlc_http import ConnectionError as ConnErr, VLCHttp
...
class VlcDevice(MediaPlayerDevice):
    ...
    def update(self):
        ...
        if self._vlc is None:
            try:
                self._vlc = VLCHttp(self._host, self._password, self._port)
